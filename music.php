  ...
  <div class="music-container">
    ...
    <div class="music-item">
      <div class="details">
        ...
        <button onclick="window.open('<?php echo htmlspecialchars($musique['lien']); ?>')" 
            class="watch-button">LISTEN</button>
      </div>
      <img src="admin/uploads/musiques/<?php echo htmlspecialchars($musique['image']); ?>" 
